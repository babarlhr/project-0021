...
class MrpProduction(models.Model):
    ...
    def _make_production_consume_line(self, line):
        move_id = super(MrpProduction, self)._make_production_consume_line(line)
...
class MrpProductionWorkcenterLine(models.Model):
    ...
    move_lines = fields.One2many(comodel_name='stock.move', inverse_name='work_order', string='Moves')
    ...
    sequence = fields.Integer(string='Sequence', related='routing_wc_line.sequence')
    operator_ids = fields.One2many('mrp.production.workcenter.operators', 'production_workcenter_line_id', 'Operators')
    ...
    def action_start_working(self):
        ...
        #    raise exceptions.Warning(_("Missing materials to start the production"))
