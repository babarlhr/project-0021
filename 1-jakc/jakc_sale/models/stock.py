...
class StockMove(models.Model):
    ...
    sale_line_id = fields.Many2one(comodel_name='sale.order.line', string='Order Line #', store=True, related='procurement_id.sale_line_id')
    sparepart_line_id = fields.Many2one('sale.order.sparepart.line', 'Sparepart Line #', index=True)
    sparepart_id = fields.Many2one('sale.order.sparepart', 'Sparepart #', index=True)
